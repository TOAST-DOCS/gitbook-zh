## Open Source > NHN Cloud TOAST UI Chart > Open Source Guide

## Download

The NHN Cloud TOAST UI products can be installed by using the package manager or downloading the source directly.
However, we highly recommend using the package manager.

### Via Package Manager

The NHN Cloud TOAST UI products are registered in [npm](https://www.npmjs.com/) package manager.
...
The NHN Cloud TOAST UI Chart is available over a CDN.
...
Add the container element where NHN Cloud TOAST UI Chart will be created.
...
The NHN Cloud TOAST UI Chart can be used by creating an instance with the constructor function. To access the constructor function, import the module using one of the three following methods depending on your environment.
